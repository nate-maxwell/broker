...
def test_notify_on_unsubscribe_flag() -> None:
    ...
    broker.set_flag_states(on_unsubscribe=True)
...
def test_notify_on_emit_flag() -> None:
    ...
    """
    broker.clear()
    broker.set_flag_states(on_emit=True)
    notifications: list[str] = []
...
def test_notify_on_new_namespace_flag() -> None:
    ...
    """
    broker.clear()
    broker.set_flag_states(on_new_namespace=True)
    notifications: list[str] = []
...
def test_notify_on_del_namespace_flag() -> None:
    ...
    broker.set_flag_states(on_del_namespace=True)
...
def test_multiple_notify_flags_together() -> None:
    ...
    broker.clear()
    broker.set_flag_states(on_subscribe=True, on_new_namespace=True, on_emit=True)
    subscribe_notifications: list[str] = []
