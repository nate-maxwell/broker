...
for the duration of a with block. Emission resumes automatically on exit, even
if an exception is raised.

Supports nesting — the broker tracks pause depth, so inner contexts exiting do
not prematurely unpause outer ones.
"""
